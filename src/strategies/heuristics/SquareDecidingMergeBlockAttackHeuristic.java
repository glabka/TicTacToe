...
public class SquareDecidingMergeBlockAttackHeuristic extends AbstractSquareHeuristic{
	...
	public boolean equals(Object o) {
		if (o == null) {
			return false;
		} else if (!(o instanceof SquareDecidingMergeBlockAttackHeuristic)) {
			return false;
		}

		SquareDecidingMergeBlockAttackHeuristic other = (SquareDecidingMergeBlockAttackHeuristic) o;
	...
	public int hashCode() {
		String str;
		if (this.filter == null) {
			str = "" + this.cooEstimator.hashCode() + 2;
		} else {
			str = "" + this.cooEstimator.hashCode() + this.filter.hashCode() + 2;
		}
		return str.hashCode();
	}
